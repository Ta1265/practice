...
side of the river. The frog can cross only when leaves appear at every position
 across the river from 1 to X (that is, we want to find the earliest moment when
     all the positions from 1 to X are covered by leaves). You may assume
...
(function () {
  console.log(solution(5, [1, 3, 1, 4, 2, 3, 5, 4]), 'expecting 6');
  console.log(solution(3, [1, 3, 1, 4, 2, 3, 5, 4]), 'expecting 6');
}());
