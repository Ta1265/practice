...
exactly one invalid node where its right child incorrectly
...
this invalid node and every node underneath it (minus the node it incorrectly points to).
...
the TreeNode with value of fromNode will have its right
child pointer pointing to the TreeNode with a value of toNode.
